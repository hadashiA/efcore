...
public class JsonQuerySqliteTest : JsonQueryTestBase<JsonQuerySqliteFixture>
{
    ...
    public override async Task Json_collection_element_access_in_predicate_nested_mix(bool async)
        => Assert.Equal(
            SqliteStrings.NonConstantJsonArrayIndexNotSupported("OwnedCollectionRoot"),
            (await Assert.ThrowsAsync<InvalidOperationException>(
                () => base.Json_collection_element_access_in_predicate_nested_mix(async)))
            .Message);
    ...
    public override async Task Json_collection_element_access_in_predicate_using_column(bool async)
        => Assert.Equal(
            SqliteStrings.NonConstantJsonArrayIndexNotSupported("OwnedCollectionRoot"),
            (await Assert.ThrowsAsync<InvalidOperationException>(
                () => base.Json_collection_element_access_in_predicate_using_column(async)))
            .Message);
    ...
    public override async Task Json_collection_element_access_in_predicate_using_complex_expression1(bool async)
        => Assert.Equal(
            SqliteStrings.NonConstantJsonArrayIndexNotSupported("OwnedCollectionRoot"),
            (await Assert.ThrowsAsync<InvalidOperationException>(
                () => base.Json_collection_element_access_in_predicate_using_complex_expression1(async)))
            .Message);
    ...
    public override async Task Json_collection_element_access_in_predicate_using_complex_expression2(bool async)
        => Assert.Equal(
            SqliteStrings.NonConstantJsonArrayIndexNotSupported("OwnedCollectionRoot"),
            (await Assert.ThrowsAsync<InvalidOperationException>(
                () => base.Json_collection_element_access_in_predicate_using_complex_expression2(async)))
            .Message);
    ...
    public override async Task Json_collection_element_access_in_predicate_using_variable(bool async)
        => Assert.Equal(
            SqliteStrings.NonConstantJsonArrayIndexNotSupported("OwnedCollectionRoot"),
            (await Assert.ThrowsAsync<InvalidOperationException>(
                () => base.Json_collection_element_access_in_predicate_using_variable(async)))
            .Message);
    ...
    public override async Task Json_collection_element_access_in_projection_nested(bool async)
        => Assert.Equal(
            SqliteStrings.NonConstantJsonArrayIndexNotSupported("OwnedCollectionRoot"),
            (await Assert.ThrowsAsync<InvalidOperationException>(
                () => base.Json_collection_element_access_in_projection_nested(async)))
            .Message);
    ...
    public override async Task Json_collection_element_access_in_projection_nested_project_collection(bool async)
        => Assert.Equal(
            SqliteStrings.NonConstantJsonArrayIndexNotSupported("OwnedCollectionRoot"),
            (await Assert.ThrowsAsync<InvalidOperationException>(
                () => base.Json_collection_element_access_in_projection_nested_project_collection(async)))
            .Message);
    ...
    public override async Task Json_collection_element_access_in_projection_nested_project_collection_anonymous_projection(bool async)
        => Assert.Equal(
            SqliteStrings.NonConstantJsonArrayIndexNotSupported("OwnedCollectionRoot"),
            (await Assert.ThrowsAsync<InvalidOperationException>(
                () => base.Json_collection_element_access_in_projection_nested_project_collection_anonymous_projection(async)))
            .Message);
    ...
    public override async Task Json_collection_element_access_in_projection_nested_project_reference(bool async)
        => Assert.Equal(
            SqliteStrings.NonConstantJsonArrayIndexNotSupported("OwnedCollectionRoot"),
            (await Assert.ThrowsAsync<InvalidOperationException>(
                () => base.Json_collection_element_access_in_projection_nested_project_reference(async)))
            .Message);
    ...
    public override async Task Json_collection_element_access_in_projection_nested_project_scalar(bool async)
        => Assert.Equal(
            SqliteStrings.NonConstantJsonArrayIndexNotSupported("OwnedCollectionRoot"),
            (await Assert.ThrowsAsync<InvalidOperationException>(
                () => base.Json_collection_element_access_in_projection_nested_project_scalar(async)))
            .Message);
    ...
    public override async Task Json_collection_element_access_in_projection_using_column(bool async)
        => Assert.Equal(
            SqliteStrings.NonConstantJsonArrayIndexNotSupported("OwnedCollectionRoot"),
            (await Assert.ThrowsAsync<InvalidOperationException>(
                () => base.Json_collection_element_access_in_projection_using_column(async)))
            .Message);
    ...
    public override async Task Json_collection_element_access_in_projection_using_parameter(bool async)
        => Assert.Equal(
            SqliteStrings.NonConstantJsonArrayIndexNotSupported("OwnedCollectionRoot"),
            (await Assert.ThrowsAsync<InvalidOperationException>(
                () => base.Json_collection_element_access_in_projection_using_parameter(async)))
            .Message);
...
//        AssertSql(
//"""
//SELECT "j"."Id", "j"."EntityBasicId", "j"."Name", "j"."OwnedCollectionRoot", "j"."OwnedReferenceRoot", json_extract("j"."OwnedReferenceRoot",'$.OwnedReferenceBranch.OwnedReferenceLeaf.SomethingSomething')
//FROM "JsonEntitiesBasic" AS "j"
//""");
//    }
...
//SELECT "j"."Id"
//FROM "JsonEntitiesBasic" AS "j"
//WHERE ef_compare(json_extract("j"."OwnedReferenceRoot",'$.OwnedReferenceBranch.Fraction'), '20.5') < 0
//""");
//    }
...
//    SELECT DISTINCT "t"."c"
//    FROM (
//        SELECT json_extract("j"."OwnedReferenceRoot",'$.OwnedReferenceBranch.OwnedReferenceLeaf.SomethingSomething') AS "c"
//        FROM "JsonEntitiesBasic" AS "j"
//        ORDER BY "j"."Id"
//        LIMIT @__p_0
//    ) AS "t"
...
//SELECT json_extract("t2"."c",'$.OwnedReferenceLeaf'), "t2"."Id"
//FROM (
//    SELECT DISTINCT "t1"."c" AS "c", "t1"."Id"
//    FROM (
//        SELECT json_extract("t0"."c",'$.OwnedReferenceBranch') AS "c", "t0"."Id"
//        FROM (
...
//            ) AS "t"
//        ) AS "t0"
//        ORDER BY json_extract("t0"."c0",'$.Name')
//        LIMIT @__p_0
//    ) AS "t1"
//) AS "t2"
//""");
...
//SELECT json_extract("t2"."c",'$.OwnedCollectionLeaf'), "t2"."Id"
//FROM (
//    SELECT DISTINCT "t1"."c" AS "c", "t1"."Id"
//    FROM (
//        SELECT json_extract("t0"."c",'$.OwnedReferenceBranch') AS "c", "t0"."Id"
...
//        AssertSql(
//"""
//SELECT json_extract("j"."json_reference_custom_naming",'$.CustomOwnedReferenceBranch'), "j"."Id"
//FROM "JsonEntitiesCustomNaming" AS "j"
//""");
//    }
...
//"""
//SELECT (
//    SELECT json_extract("j0"."OwnedReferenceRoot",'$.OwnedReferenceBranch.Date')
//    FROM "JsonEntitiesBasic" AS "j0"
//    ORDER BY "j0"."Id"
//    LIMIT 1)
//FROM "JsonEntitiesBasic" AS "j"
...
//        AssertSql(
//"""
//SELECT json_extract("j"."OwnedCollectionRoot",'$[1]'), "j"."Id"
//FROM "JsonEntitiesBasic" AS "j"
//""");
//    }
...
//        AssertSql(
//"""
//SELECT json_extract("j"."OwnedCollectionRoot",'$[1].OwnedCollectionBranch'), "j"."Id"
//FROM "JsonEntitiesBasic" AS "j"
//""");
//    }
...
//        AssertSql(
//"""
//SELECT json_extract("j"."OwnedCollectionRoot",'$[25]'), "j"."Id"
//FROM "JsonEntitiesBasic" AS "j"
//""");
//    }
...
//        AssertSql(
//"""
//SELECT json_extract("j"."OwnedCollectionRoot",'$[25].Number')
//FROM "JsonEntitiesBasic" AS "j"
//ORDER BY "j"."Id"
//""");
//    }
...
//SELECT "j"."Name"
//FROM "JsonEntitiesBasic" AS "j"
//WHERE json_extract("j"."OwnedReferenceRoot",'$.Number') <> length(json_extract("j"."OwnedReferenceRoot",'$.Name')) OR (json_extract("j"."OwnedReferenceRoot",'$.Name') IS NULL)
//""");
//    }
...
//    SELECT "t"."Key"
//    FROM (
//        SELECT json_extract("j"."OwnedReferenceRoot",'$.Name') AS "Key"
//        FROM "JsonEntitiesBasic" AS "j"
//    ) AS "t"
//    GROUP BY "t"."Key"
//) AS "t0"
...
//        SELECT "t3"."Id", "t3"."EntityBasicId", "t3"."Name", "t3"."c" AS "c", "t3"."c0" AS "c0", "t3"."Key", ROW_NUMBER() OVER(PARTITION BY "t3"."Key" ORDER BY "t3"."Id") AS "row"
//        FROM (
//            SELECT "j0"."Id", "j0"."EntityBasicId", "j0"."Name", "j0"."OwnedCollectionRoot" AS "c", "j0"."OwnedReferenceRoot" AS "c0", json_extract("j0"."OwnedReferenceRoot",'$.Name') AS "Key"
//            FROM "JsonEntitiesBasic" AS "j0"
//        ) AS "t3"
//    ) AS "t2"
...
//"""
//SELECT (
//    SELECT json_extract("t0"."c0",'$.OwnedReferenceBranch.Enum')
//    FROM (
//        SELECT "j0"."Id", "j0"."EntityBasicId", "j0"."Name", "j0"."OwnedCollectionRoot" AS "c", "j0"."OwnedReferenceRoot" AS "c0", json_extract("j0"."OwnedReferenceRoot",'$.Name') AS "Key"
//        FROM "JsonEntitiesBasic" AS "j0"
//    ) AS "t0"
...
//SELECT "j"."Id", "j"."Collection", "j"."Reference"
//FROM "JsonEntitiesAllTypes" AS "j"
//WHERE json_extract("j"."Reference",'$.TestDefaultString') <> 'MyDefaultStringInReference1' OR (json_extract("j"."Reference",'$.TestDefaultString') IS NULL)
//""");
//    }
...
//SELECT "j"."Id", "j"."Collection", "j"."Reference"
//FROM "JsonEntitiesAllTypes" AS "j"
//WHERE json_extract("j"."Reference",'$.TestNullableEnum') <> 'One' OR (json_extract("j"."Reference",'$.TestNullableEnum') IS NULL)
//""");
//    }
...
//SELECT "j"."Id", "j"."Collection", "j"."Reference"
//FROM "JsonEntitiesAllTypes" AS "j"
//WHERE json_extract("j"."Reference",'$.TestNullableEnum') IS NOT NULL
//""");
//    }
...
//SELECT "j"."Id", "j"."Collection", "j"."Reference"
//FROM "JsonEntitiesAllTypes" AS "j"
//WHERE json_extract("j"."Reference",'$.TestNullableEnumWithIntConverter') <> 1 OR (json_extract("j"."Reference",'$.TestNullableEnumWithIntConverter') IS NULL)
//""");
//    }
...
//SELECT "j"."Id", "j"."Collection", "j"."Reference"
//FROM "JsonEntitiesAllTypes" AS "j"
//WHERE json_extract("j"."Reference",'$.TestNullableEnumWithIntConverter') IS NOT NULL
//""");
//    }
...
//SELECT "j"."Id", "j"."Collection", "j"."Reference"
//FROM "JsonEntitiesAllTypes" AS "j"
//WHERE json_extract("j"."Reference",'$.TestNullableEnumWithConverterThatHandlesNulls') <> 'One' OR (json_extract("j"."Reference",'$.TestNullableEnumWithConverterThatHandlesNulls') IS NULL)
//""");
//    }
...
//SELECT "j"."Id", "j"."Collection", "j"."Reference"
//FROM "JsonEntitiesAllTypes" AS "j"
//WHERE json_extract("j"."Reference",'$.TestTimeSpan') <> '03:02:00' OR (json_extract("j"."Reference",'$.TestTimeSpan') IS NULL)
//""");
//    }
...
""");
    ...
    //        AssertSql(
    //"""
    //SELECT json_extract("m"."OwnedReferenceRoot",'$.OwnedReferenceBranch'), "m"."Id"
    //FROM (
    //    SELECT * FROM "JsonEntitiesBasic" AS j
    //) AS "m"
    //""");
    ...
    //        AssertSql(
    //"""
    //SELECT json_extract("m"."OwnedReferenceRoot",'$.OwnedCollectionBranch'), "m"."Id"
    //FROM (
    //    SELECT * FROM "JsonEntitiesBasic" AS j
    //) AS "m"
    //""");
